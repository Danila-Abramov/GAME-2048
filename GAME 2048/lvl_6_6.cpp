...
SDL_Texture* get_text_texture2(SDL_Renderer*& renderer, char* text1, TTF_Font* font1)
{
...
void draw_text_score2(SDL_Renderer*& renderer, SDL_Texture* texture)
{
	SDL_Rect rect_2 = { 1005,5, 195, 60 };
	SDL_RenderCopy(renderer, texture, NULL, &rect_2);
}

void draw_text_record2(SDL_Renderer*& renderer, SDL_Texture* texture)
{
	SDL_Rect rect_3 = { 1205,85, 60, 60 };
	SDL_RenderCopy(renderer, texture, NULL, &rect_3);
}

void draw_text_record_text2(SDL_Renderer*& renderer, SDL_Texture* texture)
{
	SDL_Rect rect_3 = { 1005,85, 195, 60 };
	SDL_RenderCopy(renderer, texture, NULL, &rect_3);
}

void functions_random_2(int** massiv, int& rand_1)
{
	bool ok = false;
	srand(time(NULL));
	for (int i = 0; i < 6; i++)
...
void functions_lvl_6_6(SDL_Renderer* renderer, bool& quit_1, int** massiv, TTF_Font* font, int *massiv_record)
{
	...
	char text1[10];
	char text_score1[10] = "score:";
	char record1[10];
	char text_record1[10] = "record:";
	...
	SDL_Rect massiv_draw = { 0,20,113,113 };
	...
	while (quit == false)
	{
		...
		if (massiv_record[2] < score)
		{
			massiv_record[2] = score;
		}

		_itoa_s(score, text1, 10);
		_itoa_s(massiv_record[2], record1, 10);
		textTexture = get_text_texture2(renderer, text1, font);
		textTexture_2 = get_text_texture2(renderer, text_score1, font);
		textTexture_3 = get_text_texture2(renderer, record1, font);
		textTexture_4 = get_text_texture2(renderer, text_record1, font);

		for (int i = 0; i < 6; i++)
		{
			for (int j = 0; j < 6; j++)
			{
				if (massiv[i][j] == 0) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_0, NULL, &massiv_draw); }
				if (massiv[i][j] == 2) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_2, NULL, &massiv_draw); }
				if (massiv[i][j] == 4) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_4, NULL, &massiv_draw); }
				if (massiv[i][j] == 8) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_8, NULL, &massiv_draw); }
				if (massiv[i][j] == 16) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_16, NULL, &massiv_draw); }
				if (massiv[i][j] == 32) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_32, NULL, &massiv_draw); }
				if (massiv[i][j] == 64) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_64, NULL, &massiv_draw); }
				if (massiv[i][j] == 128) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_128, NULL, &massiv_draw); }
				if (massiv[i][j] == 256) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_256, NULL, &massiv_draw); }
				if (massiv[i][j] == 512) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_512, NULL, &massiv_draw); }
				if (massiv[i][j] == 1024) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_1024, NULL, &massiv_draw); }
				if (massiv[i][j] == 2048) { massiv_draw.x = 300 + 113 * j; massiv_draw.y = 20 + 113 * i; SDL_RenderCopy(renderer, kletka_2048, NULL, &massiv_draw); }
		...
		for (int i = 0; i <= 10; i++)
		{
			...
			SDL_RenderDrawLine(renderer, 298 + 680 + i, 20, 300 + 678 + i, 20 + 680);
			SDL_RenderDrawLine(renderer, 300, 690 + i, 300 + 678, 690 + i);
		}
		...
		for (int i = 0; i < 6; i++)
		{
			for (int j = 0; j <= 10; j++)
			{
				SDL_RenderDrawLine(renderer, 300, 20 + 113 + 113 * i - j, 298 + 680, 20 + 113 + 113 * i - j);
				SDL_RenderDrawLine(renderer, 298 + 113 + 113 * i + j, 20, 298 + 113 + 113 * i + j, 690);
			}
		}

		draw_text2(renderer, textTexture);
		SDL_DestroyTexture(textTexture);
		draw_text_score2(renderer, textTexture_2);
		SDL_DestroyTexture(textTexture_2);
		draw_text_record2(renderer, textTexture_3);
		SDL_DestroyTexture(textTexture_3);
		draw_text_record_text2(renderer, textTexture_4);
